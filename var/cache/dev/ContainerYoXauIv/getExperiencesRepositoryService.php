 ...
 */
class getExperiencesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExperiencesRepository' shared autowired service.
     *
     * @return \App\Repository\ExperiencesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExperiencesRepository.php';

        return $container->privates['App\\Repository\\ExperiencesRepository'] = new \App\Repository\ExperiencesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
