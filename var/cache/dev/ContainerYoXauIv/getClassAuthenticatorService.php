 ...
 */
class getClassAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\ClassAuthenticator' shared autowired service.
     *
     * @return \App\Security\ClassAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'ClassAuthenticator.php';

        return $container->privates['App\\Security\\ClassAuthenticator'] = new \App\Security\ClassAuthenticator(($container->services['router'] ?? self::getRouterService($container)));
    }
}
