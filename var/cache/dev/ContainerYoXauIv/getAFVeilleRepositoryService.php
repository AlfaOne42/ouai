 ...
 */
class getAFVeilleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AFVeilleRepository' shared autowired service.
     *
     * @return \App\Repository\AFVeilleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AFVeilleRepository.php';

        return $container->privates['App\\Repository\\AFVeilleRepository'] = new \App\Repository\AFVeilleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
